...
const TERMS_CONTENT = (
  <div className="space-y-6 text-sm text-gray-700 leading-relaxed font-medium">
    ...
    <p>Welcome to <strong className="text-gray-900">LG Trust Edge!</strong> These Terms and Conditions ("Terms") govern your use of our website at <strong>https://www.LG Trust Edgeworld.com.ng</strong> and the purchase of any electronics or products from us. By accessing the Site or purchasing a product, you agree to be bound by these Terms.</p>
    ...
    {[
      ...
      },
      {
        ...
        body: 'All payments are securely processed through Korapay. We accept Naira debit cards (Visa, MasterCard, Verve), bank transfers, and pay-with-bank options. By submitting an order, you authorize LG Trust Edge (via Korapay) to charge your designated payment method for the full order amount.'
      },
      {
    ...
    <div className="border-2 border-red-400 rounded-sm overflow-hidden">
      ...
      <div className="p-4 bg-red-50 space-y-2">
        <p className="font-bold text-red-800"><strong>Final Sale:</strong> All sales on LG Trust Edge are final. We enforce a strict No-Return and No-Refund policy once an item has been purchased and successfully dispatched or delivered.</p>
        ...
        <p className="text-red-700"><strong>Manufacturer Warranties:</strong> LG Trust Edge itself does not provide additional store warranties. For any technical faults discovered after delivery, your sole remedy is to contact the manufacturer's authorized service center in Nigeria.</p>
      </div>
    </div>
    ...
    {[
      {
        ...
        body: 'All content on this Site — including text, graphics, logos, images, and software — is the property of LG Trust Edge or its content suppliers and is protected by Nigerian and international copyright, trademark, and intellectual property laws.'
      },
      {
        n: '7', title: 'Limitation of Liability',
        body: 'To the maximum extent permitted by applicable Nigerian law, LG Trust Edge shall not be liable for any indirect, incidental, special, consequential, or punitive damages including loss of profits, data, product failure, electrical surges, battery degradation, or personal injury resulting from the use or misuse of electronics purchased through the Site. Our total liability shall not exceed the amount you paid for the specific product in question.'
      },
      {
      ...
      },
      {
        ...
        body: 'LG Trust Edge reserves the right to update or modify these Terms at any time without prior notice. Your continued use of the Site following any changes constitutes your acceptance of the new Terms.'
      },
    ].map(s => (
      <div key={s.n}>
        <h3 className="font-black text-gray-900 uppercase tracking-wider text-xs mb-2 flex items-center gap-2">
    ...
    <div>
      ...
      <p>Email: support@LG Trust Edgeworld.com.ng | Phone: +234 708 044 1764 | Address: 77 Olu-Obasanjo Road Port Harcourt, Nigeria</p>
    </div>
...
const PRIVACY_CONTENT = (
  <div className="space-y-6 text-sm text-gray-700 leading-relaxed font-medium">
    <p>LG Trust Edge ("we", "our", "us") is committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information. This policy is aligned with the <strong className="text-gray-900">Nigeria Data Protection Regulation (NDPR)</strong> issued by NITDA.</p>
    ...
    {[
      ...
      <div key={s.n}>
        <h3 className="font-black text-gray-900 uppercase tracking-wider text-xs mb-2 flex items-center gap-2">
          <span className="w-5 h-5 bg-[#E2001A] text-white rounded-full flex items-center justify-center text-[10px] font-black flex-shrink-0">{s.n}</span>
          <i className={`fas ${s.icon} text-[#E2001A]`}></i>
          {s.title}
        </h3>
        <p>{s.body}</p>
      </div>
  ...
  return (
    <div className="fixed inset-0 bg-black/70 z-[100] flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-white rounded-sm w-full max-w-2xl flex flex-col shadow-2xl overflow-hidden" style={{ maxHeight: '90vh' }}>
        ...
        {/* Header */}
        <div className={`flex items-center justify-between px-6 py-4 flex-shrink-0 border-b border-gray-200 ${isTerms ? 'bg-gray-900' : 'bg-[#E2001A]'}`}>
        ...
        <div className="h-1 bg-gray-100 flex-shrink-0">
          <div
            className={`h-full transition-all duration-300 ${hasScrolledToBottom ? 'bg-green-500' : isTerms ? 'bg-gray-700' : 'bg-[#E2001A]'}`}
