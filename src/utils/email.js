...
const DEFAULT_SERVICE_ID = 'service_placeholder';
const DEFAULT_PUBLIC_KEY = 'public_key_placeholder';

// Gmail Service credentials (used for specific order templates)
const GMAIL_SERVICE_ID = 'service_placeholder';
const GMAIL_PUBLIC_KEY = 'public_key_placeholder';

// Delivery OTP credentials
const DELIVERY_SERVICE_ID = 'service_placeholder';
const DELIVERY_PUBLIC_KEY = 'public_key_placeholder';

export const TEMPLATES = {
  OTP:             'template_otp_placeholder',        // registration OTP
  RESET_PASSWORD:  'template_reset_placeholder',      // forgot password OTP
  ORDER_OTP:       'template_order_otp_placeholder',  // delivery confirmation code
  TRACKING_UPDATE: 'template_tracking_placeholder',   // shipped / status changed
  ORDER_DELIVERED: 'template_delivered_placeholder',  // delivered confirmation
};
